...
*   완전이진트리
    ...
    *   노드는 왼쪽에서 오른쪽으로 채워져야 합니다.
        ...
        ![Untitled](../Data\_Structure/image/heap001.png)
...
![Untitled](../Data\_Structure/image/heap002.png)
...
![Untitled](../Data\_Structure/image/heap003.png)
...
![Untitled](../Data\_Structure/image/heap004.png)
...
> 두 연산 모두 최악의 경우 교환 횟수는 힙의 높이(height)가 된다. 힙은 완전 이진 트리이므로 높이가 log\_2 n을 넘지 않는다. 따라서 두 연산의 시간복잡도는 O(log n)이다.
...
*   상세
    ...
    * `remove(E element)`_반환형: boolean_
      * 특정 원소 제거
...
![Untitled](../Data\_Structure/image/heap01.png) ![Untitled](../Data\_Structure/image/heap02.png) ![Untitled](../Data\_Structure/image/heap03.png) ![Untitled](../Data\_Structure/image/heap04.png)
